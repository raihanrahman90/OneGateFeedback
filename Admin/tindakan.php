                    ...
                    <table class="table" id="" width="100%" cellspacing="0">
                        ...
                        <tbody>
                                ...
                                <td>
                                    <div class="form-group-checked row">
                                        <div class="col-sm-6 mb-3-checked mb-sm-0">
                                            <input class="form-control-checked" type="radio" value="Progress"
                                                text="Progress" name="status" checked id="tindakan-progres">
                                            <label class="form-check-label form-control-checked">Progress</label>
                                        </div>
                                        <div class="col-sm-6 mb-3-checked mb-sm-0">
                                            <input type="radio" class="form-control-checked" value="Complete"
                                                text="Complete" name="status" id="tindakan-complete">
                            ...
                            <tr>
                                ...
                                <td><label>:</label></td>
                                <td><input type="file" name="laporan" id="laporan" accept='application/pdf'><br>
                                    <span class="text-danger">Masukkan laporan pdf jika perlu</span>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="3">
                                    <button type="submit" class="btn btn-info btn-icon-split float-right"
                                        data-toggle='modal' data-target='#kembaliModal'>
