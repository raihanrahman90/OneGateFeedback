          ...
          <div class="card shadow mb-4">
            <div class="card-body">
              <div class="table-responsive">
            	<form action='../action/add_departemen.php' id="my_form" method="post">
            		<table class="table" width="100%" cellspacing="0">
                  <thead>
            				<tr>
            					<td><label>Departemen</label></td>
            					<td><label>:</label></td>
            					<td colspan="3"><input type="text" name="Departemen" class="form-control form-control-user" required></td>
            				</tr>
                  </thead>
                	<tbody id="field_div">
                  			<tr>
                					<td><label>Unit</label></td>
                					<td colspan="3"><input type="button" value="Tambah unit" onclick="add_field();"></td>
                				</tr>
                    </tbody>
                    <tfoot>
                    <tr>
