...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 26, 2022 at 03:17 AM
...
(29, NULL, 100, NULL, NULL, NULL, 'detail lokasi', 'Gedung parkir terminal', 'Keluhan', 1, 'Konsleting Listrik', 'Mitra', 'keterangan', 'Request', '2021-11-20 20:25:32', '2021-11-20 20:25:32', '2021-11-18', NULL, '29.png', 0),
(30, NULL, 100, NULL, NULL, NULL, 'adfasdf', 'Gedung parkir terminal', 'Keluhan', 1, 'Konsleting Listrik', 'Mitra', 'butuh elokasi', 'Request', '2021-12-07 20:01:43', '2021-12-07 20:01:43', '2021-12-06', NULL, '30.png', -1),
(31, 132, 100, 61, 'TES 1', 'Service Test', 'gerbang', 'Kedatangan sisi barat', 'Keluhan', 1, 'Plafon runtuh', 'Mitra', 'di kanntor tengah', 'Closed', '2022-02-17 10:17:10', '2022-02-17 10:15:36', '2022-02-16', NULL, '31.jpg', 1);
...
(117, 'J.Co', 'Balikpapan', 'Raihan', '11@gmail.com', '080808', 'f6cbdd813504cf91db5f028137b84b99', 0, '2022-02-02', '2022-02-02', '12313213', '117.png', '117.jpg', '2021-11-22');
...
(62, 29, 132, 'minta keterangan dungs oleh raihan', 'ini jawaban', '44f683a84163b3523afe57c2e008bc8c', '62.png');
...
('11@gmail.com', '2021-11-23 16:23:57');
...
(440, NULL, 29, 'Feedback dikirim oleh Mitra', NULL, '2021-11-20 20:25:32'),
(441, NULL, 30, 'Feedback dikirim oleh Mitra', NULL, '2021-12-07 20:01:43'),
(442, NULL, 31, 'Feedback dikirim oleh Mitra', NULL, '2022-02-17 10:15:36'),
(443, 132, 31, 'Diteruskan ke unit TES 1, mohon dikerjakan oleh raihan', NULL, '2022-02-17 10:17:10'),
(444, 132, 31, 'Feedback direspons oleh unit dengan keterangan memesan plafon', NULL, '2022-02-17 10:18:13'),
(445, 132, 31, 'Feedback telah selesai ditindaklanjuti oleh unit dengan keterangan sudah diperbaiki', '445.jpg', '2022-02-17 10:19:10'),
(446, 132, 31, 'Closed oleh raihan', NULL, '2022-02-17 10:19:52');
...
--
-- Table structure for table `tb_urgensi`
--
...
--
-- Dumping data for table `tb_urgensi`
--
...
--
ALTER TABLE `tb_aduan`
  MODIFY `id_aduan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
...
--
ALTER TABLE `tb_customer`
  MODIFY `id_customer` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=118;
...
--
ALTER TABLE `tb_keterangan_tambahan`
  MODIFY `id_keterangan` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=63;
...
--
ALTER TABLE `tb_progress`
  MODIFY `id_progress` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=447;
...
--
-- AUTO_INCREMENT for table `tb_urgensi`
--
ALTER TABLE `tb_urgensi`
