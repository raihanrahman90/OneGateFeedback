<?php
	...
	if($kelompok=="rata-rata"){
	    ...
	    if($rentang=='Tahun'){
        	$data = mysqli_query($koneksi,"SELECT count(tb_aduan.id_aduan), jenis, year(date(waktu_kirim)) FROM tb_aduan 
                                            inner join tb_penilaian on tb_penilaian.id_aduan = tb_aduan.id_aduan 
        	...
        	$data = mysqli_query($koneksi,"SELECT count(tb_aduan.id_aduan), jenis, DATE_FORMAT(date(waktu_kirim),'%Y-%m') FROM tb_aduan  
                                            inner join tb_penilaian on tb_penilaian.id_aduan = tb_aduan.id_aduan 
    	    ...
    	    $data = mysqli_query($koneksi,"SELECT count(tb_aduan.id_aduan), jenis, DATE_FORMAT(date(waktu_kirim),'%d-%m-%Y') FROM tb_aduan  
                                            inner join tb_penilaian on tb_penilaian.id_aduan = tb_aduan.id_aduan 
