...
$detail_lokasi = $koneksi -> real_escape_string($_POST['detail-lokasi']);
...
if(is_uploaded_file($_FILES['foto']['tmp_name'])){
    ...
    echo "q";
    echo $id_aduan;
    $cek = mysqli_query($koneksi,"UPDATE tb_aduan SET jenis='$jenis', ket='$keterangan', perihal='$perihal', status='$status', id_detail_lokasi='$detail_lokasi' WHERE id_aduan = '$id_aduan'") or die(mysqli_error($koneksi));
